                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="item-product">
                                    <div class="thumb">
                                        <a href="{{URL::to('/chi-tiet-san-pham/'.$pro->product_slug)}}"><img src="{{URL::to('public/uploads/products/'.$pro->product_image)}}" alt=""></a>
                                    ...
                                    <div class="info-product">
                                        ...
                                        <a href="{{URL::to('/chi-tiet-san-pham/'.$pro->product_slug)}}"><button type="button" class="btn btn-primary">Xem chi tiết</button></a>
                                    </div>
